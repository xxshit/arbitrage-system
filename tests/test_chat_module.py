...
class ChatModuleTests(unittest.TestCase):
    ...
    def test_chat_frontend_coalesces_reads_and_deduplicates_rendering(self):
        ...
        self.assertNotIn("function chatConversationIsForeground", script)
        self.assertNotIn("function chatViewIsForeground", script)
        ...
        self.assertIn("20260811-chat-audio-fix", page)
